...
export function SignupPage() {
  ...
  return (
    <div className="min-h-screen gradient-bg flex items-center justify-center p-4">
      <div className="fixed top-20 right-20 w-72 h-72 bg-indigo-200/30 rounded-full blur-3xl pointer-events-none" />
      <div className="fixed bottom-20 left-20 w-96 h-96 bg-violet-200/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1 text-sm">Get started with TaskSpace today</p>
        </div>
